...
```{r}
# Dataframe reading: select "final_som.csv" file
...
# Plotting Dendrogram and Silhouette coefficients in the custom K range
plot(2:10, sil_width[2:10], type = "b", pch = 19, frame = FALSE, 
     xlab = "Number of clusters", ylab = "Silhouette coefficient",
     main = "Silhouette method", ylim = c(0, 0.5))
...
plot(hc_eta, sub = "", xlab = "") # plotting the dendrogram
```
...
plot(hc_area, sub = "", xlab = "") # Plotting dendrogram
```
...
cbooks_area <- xyf_area$codes[[1]];cbooks_area
